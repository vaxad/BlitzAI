...
export default function Home() {
  ...
  return (
    <main className="fixed top-[80px] left-0 min-h-[89vh] flex-col items-center justify-center px-12 bg-slate-100 dark:bg-black  selection:bg-violet-300 text-slate-950 dark:text-slate-100">
      {/* <Navbar/> */}
