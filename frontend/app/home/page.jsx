      ...
      <div className='flex py-6 flex-row gap-5'>
        ...
        <Tabs defaultValue="grid" className="w-fit">
          <TabsList className="grid w-fit grid-cols-2">
            <TabsTrigger value="grid" onClick={() => { setTab("grid") }}> <CiGrid42 /></TabsTrigger>
            <TabsTrigger value="list" onClick={() => { setTab("list") }}><CiBoxList /></TabsTrigger>
          </TabsList>
        </Tabs>
      </div>
      <Tabs >
        {/* <TabsList className="grid w-fit grid-cols-2">
        <TabsTrigger value="grid" id="gridtab"></TabsTrigger>
        <TabsTrigger value="list" id="listtab"></TabsTrigger>
      </TabsList> */}
        {tab === "grid" ?
